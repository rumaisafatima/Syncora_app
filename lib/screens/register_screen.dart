...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  double get _formProgress {
    int total = 6;
    int valid = 0;
    if (AppValidators.firstName(_firstNameController.text) == null) valid++;
    if (AppValidators.lastName(_lastNameController.text) == null) valid++;
                      ...
                      children: [
                        ...
                        DropdownButtonFormField<Gender>(
                          ...
                          items: Gender.values
                              ...
                              .toList(),
                          validator: (val) => AppValidators.gender(val?.name),
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: (isLoading || _formProgress < 1.0) ? null : _submit,
